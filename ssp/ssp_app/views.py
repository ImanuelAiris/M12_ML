...
from .machinelearning import mlfeedwater, mlsteam, mlfurnance

machinelearning1 = mlfeedwater
machinelearning2 = mlsteam
machinelearning3 = mlfurnance
...
def webview(request):
    ...
    aktuator1 = machinelearning1.hitungml(konduktivitas, tekanan, temperatur)
    ...
    aktuator2 = machinelearning2.hitungml(ph, oksigen, aliran)
    ...
    aktuator3 = machinelearning3.hitungml(gas, suara, kelembaban)
    return render(request, 'webview.html', {'views1': view1, 'views2':view2, 'views3':view3, 'act1':aktuator1, 'act2':aktuator2, 'act2':aktuator3})
